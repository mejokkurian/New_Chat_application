...
firebase.initializeApp({
  apiKey: "AIzaSyCTSmYUtxyaab7W5cz0ivLzWqzfdGTPLW8",
  authDomain: "chat-app-7cfcc.firebaseapp.com",
  projectId: "chat-app-7cfcc",
  storageBucket: "chat-app-7cfcc.appspot.com",
  messagingSenderId: "916277419448",
  appId: "1:916277419448:web:c53acf0d6a659613eec34d",
  measurementId: "G-2RJJCZDNEF"
});
...
function App() {
  ...
  const brandLogo = darkMode
    ...
    : `https://i.pinimg.com/474x/0d/0b/21/0d0b211c1ecc0562b9f4c2a4305c9436.jpg`;
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-coolDark-500 dark:text-white transition-colors">
      ...
      >
        <a href='##' >
          <img style={{width:'60px'}} src={brandLogo} alt="AlterClass" width={150} />
        </a>
